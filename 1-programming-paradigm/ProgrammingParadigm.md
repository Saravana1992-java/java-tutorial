...
A **Programming paradigm** is an idea - a way of thinking about **structuring code** and **solving problems**. It defines principles, structure, and practices.
...
|------------------------|--------------------------------------------------|----------------------------------------------|---------------------------------------------------------------------------------------------|
| [**Procedural**](./ProceduralVsOOPogramming.md)         | Think in moduler                                   | Organize logic as sequences of procedures    | **C, Pascal, BASIC** — Simple control flow, great for system-level programming              |
| [**Object-Oriented**]((./ProceduralVsOOPogramming.md))    | Think in objects                                 | Encapsulate state and behavior in classes    | **Java, C++, Python, .NET** — Great for Enterprise apps, GUIs, simulations             |
| [**Imperative**](./ImperativeVsDeclarativeProgramming.md)         | Think in step by step implementation                               | Specify exact steps to change state          | **C, Python, JavaScript** — Great for System programming, embedded systems                         |
